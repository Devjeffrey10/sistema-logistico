...
export default function UsersPage() {
  ...
  const handleAddUser = async () => {
    ...
    try {
      ...
      if (newUserImage) {
        try {
          imageUrl = await resizeImage(newUserImage, 400, 400, 0.8);
        } catch (error) {
          toast({
            title: "Erro",
    ...
    <div className="space-y-6">
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              <ImageUpload
                ...
                value={newUserImage ? URL.createObjectURL(newUserImage) : null}
                onChange={(file) => setNewUserImage(file)}
      ...
      >
        ...
        <TabsContent value="permissions">
          <Card>
            <CardHeader>
              <CardTitle>Configuração de Permiss��es</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
