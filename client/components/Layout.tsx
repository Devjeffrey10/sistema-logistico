  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r bg-card px-6 pb-4">
          <div className="flex h-16 shrink-0 items-center">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg font-semibold">Sistema Logistico</h1>
      ...
      <div className="lg:pl-72">
        ...
        {/* Footer */}
        <footer className="border-t bg-card/50 px-4 sm:px-6 lg:px-8 py-4">
          <div className="mx-auto max-w-7xl text-center text-xs text-muted-foreground">
            <p>© 2025 Sistema Logistico - Desenvolvido por nexcodepe</p>
          </div>
        </footer>
      </div>
    </div>
